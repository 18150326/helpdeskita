...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-12-2021 a las 05:42:54
...
CREATE TABLE `t_reportes_finalizados` (
  ...
  `fechayfirma1` text NOT NULL,
  `aprobado` text NOT NULL,
  `fechayfirma2` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- AUTO_INCREMENT de la tabla `t_reportes_finalizados`
--
ALTER TABLE `t_reportes_finalizados`
  MODIFY `no_control` int(10) NOT NULL AUTO_INCREMENT;
